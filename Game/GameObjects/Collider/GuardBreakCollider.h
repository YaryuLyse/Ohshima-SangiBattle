...
namespace Lyse
{
	...
	class GuardBreakCollider : public Lyse::SphereCollider
	{
	public:
		// コンストラクタ
		GuardBreakCollider();
		...
		// 攻撃フラグを設定
		void SetGuardBreakFlag(bool flag) { m_guardBreakFlag = flag; }

		// 攻撃フラグを取得
		bool GetGuardBreakFlag() const { return m_guardBreakFlag; }
