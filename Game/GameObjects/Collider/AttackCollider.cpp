...
* @brief コンストラクタ
*/
Lyse::AttackCollider::AttackCollider()
...
*/
void Lyse::AttackCollider::SetPosition(DirectX::SimpleMath::Vector3 position)
{
	m_position = position;
}
...
* @param radius : 設定する半径
*/
void Lyse::AttackCollider::SetRadius(float radius)
{
	m_radius = radius;
}
...
*/
void Lyse::AttackCollider::Render(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>& batch)
{
...
*/
void Lyse::AttackCollider::OnCollision(SphereCollider* other)
{
