/**
* @file MoveLeftState.cpp
* @brief 敵の左移動状態を管理するクラスの実装ファイル
...
namespace 
{
	constexpr float LEFT_MOVE_X = 0.1f; // 後退時のZ軸移動量
}
...
*/
MoveLeftState::MoveLeftState(Lyse::Character* chara)
	: m_chara(chara)
{
}
...
*/
void MoveLeftState::Update(const DirectX::Keyboard::KeyboardStateTracker& keyboardStateTracker, float elapsedTime)
{
	...
	m_moveOffset = DirectX::SimpleMath::Vector3(LEFT_MOVE_X, 0.0f, 0.0f);
