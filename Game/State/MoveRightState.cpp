/**
* @file MoveRightState.cpp
* @brief 敵の右移動状態を管理するクラスの実装ファイル
...
namespace 
{
	constexpr float RIGHT_MOVE_X = -0.1f; // 後退時のZ軸移動量
}
...
*/
MoveRightState::MoveRightState(Lyse::Character* chara)
	: m_chara(chara)
{
}
...
*/
void MoveRightState::Update(const DirectX::Keyboard::KeyboardStateTracker& keyboardStateTracker, float elapsedTime)
{
	...
	m_moveOffset = DirectX::SimpleMath::Vector3(RIGHT_MOVE_X, 0.0f, 0.0f);
...
* @brief 更新後処理
*/
void MoveRightState::PostUpdate()
{
}
