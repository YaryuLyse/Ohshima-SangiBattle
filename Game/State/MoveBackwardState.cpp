/**
* @file MoveBackwardState.cpp
* @brief 敵の後退状態を管理するクラスの実装ファイル
...
namespace 
{
	constexpr float BACKWARD_MOVE_Z = -0.1f; // 後退時のZ軸移動量
}
...
*/
MoveBackwardState::MoveBackwardState(Lyse::Character* chara)
	: m_chara(chara)
{
}
...
* @brief 初期化処理
*/
void MoveBackwardState::Initialize()
{
}
...
* @brief 更新前処理
*/
void MoveBackwardState::PreUpdate()
{
}
...
*/
void MoveBackwardState::Update(const DirectX::Keyboard::KeyboardStateTracker& keyboardStateTracker, float elapsedTime)
{
	...
	m_moveOffset = DirectX::SimpleMath::Vector3(0.0f, 0.0f, BACKWARD_MOVE_Z);
...
* @brief 更新後処理
*/
void MoveBackwardState::PostUpdate()
{
}
...
* @brief 終了処理
*/
void MoveBackwardState::Finalize()
{
}