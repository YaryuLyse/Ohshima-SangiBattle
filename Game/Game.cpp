...
void Game::CreateDeviceDependentResources()
{
    ...
    m_debugFont = std::make_unique<Lyse::DebugFont>(device, context, L"Resources/Font/SegoeUI_18.spritefont");

    if (!m_userResources) m_userResources = std::make_unique<UserResources>();
    if (!m_sceneManager) m_sceneManager = std::make_unique<Lyse::SceneManager<UserResources>>(m_userResources.get());
...
{
    // TODO: Add Direct3D resource cleanup hered
